...
/* Avatar rond logo DETEXI dans le header */
+'._hav{width:40px;height:40px;border-radius:50%;overflow:hidden;flex-shrink:0;background:#2aa8a8;border:2px solid rgba(42,168,168,.6)}'
...
/* Avatar bot = logo rond DETEXI */
+'._mav{width:28px;height:28px;border-radius:50%;overflow:hidden;flex-shrink:0;background:#1a2e35;border:1.5px solid rgba(42,168,168,.3)}'
...
/* Header avec logo rond DETEXI + nom */
var hd=document.createElement('div');hd.id='_dtxhd';
hd.innerHTML='<div class="_hi">'
  +'<div class="_hav"><img src="'+ICON_URL+'" alt="DETEXI"/></div>'
  +'<div><div class="_hn">DETEXI Assistent</div><div class="_st"><span class="_sd"></span>Online &mdash; antwoordt direct</div></div>'
  +'</div>'
